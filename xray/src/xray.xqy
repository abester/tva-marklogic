...
import module namespace modules = "http://github.com/robwhitby/xray/modules" at "/ext/xquery/xray/src/modules.xqy";
...
) as element()*
{
  try {
    xdmp:eval('
      xquery version "1.0-ml";
      import module namespace xray = "http://github.com/robwhitby/xray" at "/ext/xquery/xray/src/xray.xqy";
      import module namespace test = "http://github.com/robwhitby/xray/test" at "' || $path || '";
